...
exports['file.expandMapping'] = {
  ...
  'basic matching': function(test) {
    ...
    var expected = [
      {dest: 'dest/expand/d.eep/deep.txt', src: 'expand/d.eep/deep.txt'},
  ...
  'flatten': function(test) {
    ...
    var expected = [
      {dest: 'dest/deep.txt', src: 'expand/d.eep/deep.txt'},
  ...
  'ext': function(test) {
    ...
    var expected = [
      {dest: 'dest/expand/d.eep/deep.foo', src: 'expand/d.eep/deep.txt'},
  ...
  'cwd': function(test) {
    ...
    var expected = [
      {dest: 'dest/d.eep/deep.txt', src: 'expand/d.eep/deep.txt'},
  ...
  'rename': function(test) {
    ...
    var expected = [
      {dest: 'dest/expand/o-m-g/deep.txt', src: 'expand/d.eep/deep.txt'},
...
exports['file'] = {
  ...
  'recurse': function(test) {
    ...
    expected[rootdir + '/d.eep/deep.txt'] = [rootdir, 'd.eep', 'deep.txt'];
